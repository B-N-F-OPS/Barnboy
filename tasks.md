...
- users to only change their own records

CLERK
- on first render user is taken to signin form
- users to only view dashboard after signing in

DEPLOYMENT
-vercel deployment

* FIX APP TO BE AN APP ROUTER NOT A PAGES ROUTER APP
